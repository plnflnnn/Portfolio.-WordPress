<?php 
/*
Template Name: Contacts & Reviews
*/
?>
...
<div class="contacts">
    <h1 class="title"><?php the_field('location_title'); ?></h1>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
        ...
        <div class="row">
                    ...
                    <div class="contacts__phones">
                        <div class="contacts__phoneblock">
                            ...
                            <div class="contacts__phonewrap">
                                ...
                                <a href="tel:<?php the_field('phone_number_first', 2); ?>">
                                <?php the_field('phone_number_first', 2); ?>
                                </a>
                            </div>
                        </div>
                        <div class="contacts__phoneblock">
            ...
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    <?php echo do_shortcode('[contact-form-7 id="de4a65b" title="Contact form 1 Review"]'); ?>
                </div>
            </div>
        </div>
        <div class="row mt70">
