        <div class="question">
            ...
            <div id="reply" class="minibutton">Ask</div>
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <div>
                <?php echo do_shortcode('[contact-form-7 id="b63f2c6" title="Contact form 2 Question"]'); ?>                    
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:<?php the_field('phone_number_first', 2); ?>"><?php the_field('phone_number_first', 2); ?></a>
                                    <a href="tel:<?php the_field('phone_number_second', 2); ?>"><?php the_field('phone_number_second', 2); ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
                                <img src="<?php echo bloginfo('template_url');  ?>/assets/img/icons/svg/pointer.svg" alt="location" class="footer__contacts-logo">
                                <address>
