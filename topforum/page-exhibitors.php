...
?>
    ...
    <main>
        ...
        <div class="conference_block" name="conference" id="conference">
                ...
                <?php
                    $category_id = get_cat_ID( 'Israel2016 exhibitors' );
                    $category_link = get_category_link( $category_id );

                    $category_id_1 = get_cat_ID( 'Another conference exhibitors' );
                    $category_link_1 = get_category_link( $category_id_1 );
    
                    $category_id_2 = get_cat_ID( 'Another conference 2016 exhibitors' );
